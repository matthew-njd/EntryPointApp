export const EN = {
  ...
  admin: {
    ...
    totalSalesReps: 'Total Sales Reps',
    ...
    confirmActivateBody:
      'Are you sure you want to activate {{email}}? They will regain access to the app.',
  ...
  userEdit: {
    ...
    salesRepAssignment: 'Sales Rep Assignment',
    assignSalesRep: 'Assign Sales Rep:',
    noSalesRepAssigned: 'No sales rep assigned',
    noSalesRepsAvailable:
      'No active sales reps available. Please assign a user the Sales Rep role first.',
    created: 'Created',
    ...
    roleDescSalesRep:
      'Reviews team timesheets before they reach the manager. Cannot submit their own timesheets.',
  ...
  manager: {
    ...
    allStatuses: 'All Statuses',
    pending: 'Pending',
    pendingManager: 'Awaiting My Review',
    pendingSalesRep: 'Pending (Sales Rep Review)',
    draft: 'Draft',
  ...
  salesRep: {
    ...
    filterByStatus: 'Filter by Status',
    allStatuses: 'All Statuses',
    pendingSalesRep: 'Awaiting My Review',
  ...
  status: {
    pending: 'Pending',
    pendingsalesrep: 'Pending (Sales Rep)',
  ...
  toast: {
    ...
    salesRepAssigned: 'Sales rep assigned successfully!',
    failedAssignSalesRep: 'Failed to assign sales rep',
    salesRepRemoved: 'Sales rep removed successfully!',
    failedRemoveSalesRep: 'Failed to remove sales rep',
  },
  payrollBanner: {
