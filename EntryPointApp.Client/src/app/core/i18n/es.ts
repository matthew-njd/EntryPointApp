export const ES = {
  ...
  errors: {
    ...
    timeOutAfterTimeIn: 'La hora de salida debe ser posterior a la hora de entrada',
    fixDayErrors: 'Por favor, corrija los errores en los días resaltados arriba antes de continuar.',
  ...
  timesheet: {
    ...
    longDayWarning: 'Esta entrada registra {{hours}} hrs — por favor verifique sus horarios.',
  ...
  toast: {
    ...
    atLeastOneDayRequired: 'Por favor complete al menos un día antes de guardar.',
    dayErrorsOnSubmit: '{{count}} día(s) tienen errores — por favor revise las entradas resaltadas.',
    failedCreateTimesheet: 'No se pudo crear la hoja de tiempo — por favor intente de nuevo.',
    failedSaveDailyLogs: 'El borrador fue creado pero las entradas diarias no se guardaron — edite el borrador desde su panel.',
    failedUpdateTimesheet: 'No se pudieron guardar los cambios — por favor intente de nuevo.',
